...
class DownloadsData {
  ...
  Future<List<Map<String, dynamic>>> getDownloadsJSONData() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    // prefs.clear();
    // print("region cleared");
    List<String> rawJsonData = prefs.getStringList('downloads');
    print(rawJsonData);
  ...
  Future<void> getObjectFromJSON() async {
    List<Map<String, dynamic>> bookmarksJSONData = await getDownloadsJSONData();
  ...
  List<BookListItem> getDownloadedBooks() {
